...
const PALETTES = {
  ...
  mom:    {skin:'#fad8ba', hair:'#1e1a1e', cloth:'#f7f3ea', cloth2:'#8e96aa', hairStyle:'medium', outfit:'tee', skirt:true, fem:true, eye:'#3a2420', sprite:'seeun', mouth:'open'},
  mom_work:{skin:'#fad8ba', hair:'#1e1a1e', cloth:'#f7f3ea', cloth2:'#6e7488', hairStyle:'bun', outfit:'apron', fem:true, eye:'#3a2420'},
  dad:    {skin:'#f3c9a0', hair:'#1c1718', cloth:'#2e64b4', cloth2:'#2a3246', collar:'#1b3060', hairStyle:'swept', outfit:'polo', shortSleeve:true, eye:'#2a1a14', mouth:'open'},
      ...
      street1:{
        ...
        npcs:[
          ...
          { id:'eros1', x:470, plat:0, label:"사랑의 신 에로스", palette:'eros', reward:['eros_bow'], lines:[
            {speaker:'eros', text:"'쉿 — 방금 내가 쏜 화살, 제대로 박혔지?'\n\n날개 달린 소년이 킥킥 웃으며 눈앞에 내려앉았다. 사랑의 신 《에로스》였다."},
